/* Lotus Leaderboard service worker — makes the app installable and offline-capable.
...
var CACHE = "lotus-leaderboard-v100";
...
self.addEventListener("fetch", function (e) {
  ...
  if (url.pathname.indexOf("/leaderboard/") !== 0) return;
